def populate_space_type_data(building_type)
  ...
  return [space_type_hash,building_static_hoo_start,building_static_hoo_finish]
end
...
def create_json_v2(structure_id, building_type, year, system_type)

  space_type_data = populate_space_type_data(building_type)
  space_type_hash = space_type_data[0]
  building_static_hoo_start = space_type_data[1]
  building_static_hoo_finish = space_type_data[2]
...
=end
  ...
  measures << {
    ...
    :arguments => [
      ...
      {
        :name => 'run_measure',
        :value => 0 # valid options are 0 or 1
      }
    ]
  }
...
namespace :test_models do
  ...
  task :jsons_v2 do
    ...
    hash.each do |k,v|
      ...
      hash_year = v[1]
      hvac_sys = v[2]
      create_json_v2(analytic_record, hash_building_type, hash_year,hvac_sys)
    end
